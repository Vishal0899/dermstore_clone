		...
		<div>
			<div className="upper-box">
				...
				{SliderData.map((slide, index) => {
					return (
						<div
							key={index}
							className={index === state ? "slide_action" : "slide"}>
							{index === state && (
								<img src={slide.image} alt="images" className="image-map" />
							)}
						</div>
					);
				})}
			</div>
			<h4 className="title_15">
				15% off + Extra 20% Off Auto-Replenishment on SkinMedica
			</h4>
			<p className="pars">
				Save on top skin care formulas rooted in science and created by
				dermatologists. Plus, receive a Skinmedica Vitamin C+E Complex 0.25 oz
				($29 value) when you spend $160 or more on the brand.
			</p>
			<div className="extra-low">
				<img
					src="https://static.thcdn.com/images/medium/webp/widgets/208-us/10/0428-STDCRE-35244-DS-MB-Dermstore-May-Photography-THG0034748-PRIORITY-SHOTS-16-HP_LPSQ_BANNER_676x556-041110.jpg"
					alt=""
					style={{
						marginLeft: "50px",
					}}
				...
				<div className="second_extra_low">
					<FaArrowAltCircleLeft
						className="second_left-arrow"
						onClick={prevstate}
					/>
					<FaArrowAltCircleRight
						className="right_left-arrow"
						onClick={nextstate}
					/>
					{second_extra.map((e, index) => (
						<div key={index} className={index === state ? "slide_act" : "sl"}>
							{index === current && (
								<div>
									<img src={e.image} alt="images" className="image2-map" />{" "}
									<br />
									<div className="data">
										<p>{e.title}</p>
										<span>
			...
			<div
							...
							{index === state && (
								<div className="set_all">
									<div>
										...
										<p>{e.price1}</p>
										<button className="button_1">QUICK BUY</button>
									</div>
									<div>
				...
				<div className="image-big">
					<img
						src="https://static.thcdn.com/images/large/webp/widgets/208-us/40/original-0429-STDCRE-35241-CM-DS-Disrupter-Banner-SCF-1640x244--022640.jpg"
						alt=""
					/>
				</div>
				<div
