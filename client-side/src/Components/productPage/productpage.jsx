  ...
  return (
    <div style={{ width: "100%", display: "flex" }}>
      <div className="sort">
        ...
        <div>
          ...
          <div className="Brands">
            {brands.map((e,index) => {
              return (
                <div key={index} onClick={() => handleBrand(e[0])} className="SI">
                  <button></button>
                  <p>{`${e[0]} (${e[1]})`}</p>
                </div>
              );
      ...
      <div className="product">
        <div className="HPP">
          <p style={{fontSize : "x-large",fontFamily: "serif", marginBottom : "0"}}>Lipstick</p>
          <p style={{marginTop : "1%"}}>29 results</p>
          <p style={{fontSize : "80%"}}>
            Perfecting your pout takes just a single swipe of this velvety rich
            trick: lipstick. Whether you want to simply enhance the color of
            your lips or hydrate them with a clear moisturizing gloss, lipstick
            is one of those cosmetics that women simply can't—and won't—go
            without. Here at Dermstore, we've taken the guesswork out of finding
            the perfect shade from top brands like jane iredale, DHC and Tarte
            Cosmetics.
          </p>
        </div>
            ...
            return (
              <div key={index} style={{ width: "99%" }}>
                ...
                <div className="TRP">
                  ...
                  <h3 name="price" style={{ marginTop: "0px" }}>
                    $ {elem.price}
                  </h3>
                </div>
                <div
